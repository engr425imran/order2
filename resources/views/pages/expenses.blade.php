...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Expense List</h3>
            <div class="row breadcrumbs-top">       
            </div>
        </div>
        <div class="content-header-right text-md-right col-md-6 col-12">
            <div class="form-group">
                <a href="{{ route('add.expense') }}" class="btn-icon btn btn-secondary btn-round btn-success"><i class="fa fa-product-hunt"></i> Add New </a>
            </div>
        </div>
    </div>

    @php 
        $get_inv_1 = ExpenseController::get_invoice(1);
        $get_inv_2 = ExpenseController::get_invoice(2);
        $get_inv_3 = ExpenseController::get_invoice(3);
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <ul class="nav mt-3 mb-3 nav nav-pills nav-pills-cust nav-pills-icons" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#a_payment" role="tab" data-toggle="tab"><i class="fa fa-money" aria-hidden="true"></i>Awaiting Payment</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="#paid" role="tab" data-toggle="tab"><i class="fa fa-money" aria-hidden="true"></i>Paid</a>
                            </li>
                        </ul>
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($expenses as $item)
                                                @php
                                                    $paid = DB::table('inv_payment_details')->where('inv_id', $item->expense_id)->sum('amount');
                                                    ...
                                                    <td>
                                                        @if ($item->status == 1 || $item->status == 2)
                                                            <button 
                                                                ...
                                                                onclick="window.location='{{ url('/cubebooks/edit-expense/'.$item->expense_id) }}'"
                                                                >
                                                                <i class="ft-edit-2"></i>                                                
                                                            </button>
                                                        @endif
                                                        ...
                                                        @if ($item->status == 3)
                                                            <button 
                                                                ...
                                                                onclick="window.location='{{ url('/cubebooks/view-expense/'.$item->expense_id) }}'"
                                                                >
