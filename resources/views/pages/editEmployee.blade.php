...
@section('content')
<div class="card-header" style="width: 800px; margin-left: 225px;">
    ...
    <div class="" id="xlarge" tabindex="-1" role="dialog" aria-labelledby="myModalLabel16">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="employee_code" class="form-control" value="{{$employees->employee_code}}">
                                    <input type="hidden" name="e_id" class="form-control" value="{{$employees->employee_id}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="dob" id="" class="form-control datepicker" value="{{$employees->dob}}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Email Address:</label>
                                    <input type="email" name="email" id="" class="form-control" value="{{$employees->email}}" required>
                                </div>
                            </div>
                                ...
                                <div class="tab-content px-1 pt-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Postal Address</label><!--  <label> (Same as Billing Address) <input type="checkbox" id="shipadd" name="shipadd"></label> -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="emergency_contact_name" id="b_street" placeholder="Contact Person" value="{{$contact_info->emergency_contact_name}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="emergency_contact_number1" id="b_street" placeholder="Contact Telephone Number 1" value="{{$contact_info->emergency_contact_number1}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="emergency_contact_number2" id="b_street" placeholder="Contact Telephone Number 2" value="{{$contact_info->emergency_contact_number2}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="other_bank" class="form-control" value="{{$bank_info->other_bank}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Branch Code</label>
                                                        <input type="text" name="branch_code" class="form-control" value="{{$bank_info->branch_code}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Branch Name</label>
                                                        <input type="text" name="branch_name" class="form-control" value="{{$bank_info->branch_name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="acc_holder_name" class="form-control" value="{{$bank_info->acc_holder_name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                    ...
                                    <div class="tab-pane" id="tab3" role="tabpanel" aria-labelledby="base-tab3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="irp5_start_date" id="" class="form-control form-control-sm datepicker ren_due change_data" value="{{$e_taxes->irp5_start_date}}">
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="directories_number_1" class="form-control" value="{{$e_taxes->directories_number_1}}">
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" name="directories_number_2" class="form-control" value="{{$e_taxes->directories_number_2}}">
                                            </div>
                                            <div class="col-md-3">
                                                <input type="text" name="directories_number_3" class="form-control" value="{{$e_taxes->directories_number_3}}">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                               <input type="text" name="income_tax_number" class="form-control" value="{{$e_taxes->income_tax_number}}">
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                               <input type="checkbox" name="voluntary_paye" class="form-control" value="{{$e_taxes->voluntary_paye}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="checkbox" name="sdl" class="form-control" value="{{$e_taxes->sdl}}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <input type="checkbox" name="oid" class="form-control" value="{{$e_taxes->oid}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="no_of_beneficiaries" class="form-control" value="{{$e_medical->no_of_beneficiaries}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="total_paid_frequency" class="form-control" value="{{$e_medical->total_paid_frequency}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 hide" id="company-portion">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="company_portion" class="form-control" value="{{$e_medical->company_portion}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="private-portion">
                                                <div class="form-group">
                                                    <label>Private Portion: </label>
                                                    <input type="text" name="private_portion" class="form-control" value="{{$e_medical->private_portion}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="aid-credits">
                                                <div class="form-group">
                                                    <label>Medical Aid Tax Credits:</label>
                                                    <input type="text" name="tax_credits" class="form-control" value="{{$e_medical->tax_credits}}">
                                                </div>
                                            </div>
