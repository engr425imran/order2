                                            ...
                                            <table class="table inv_table table-responsive">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="content_data">
                                                        ...
                                                        <td>
                                                            <div class="form-group form-group-sm">
                                                                <input type="number" name="discount[]" min="0" step="0.01" class="form-control form-control-sm discount" value="0" readonly>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="w-12">
                                                            <div class="form-group form-group-sm">
                                                                <select name="tax[]" class="form-control form-control-sm notax addtax return_sell_tax">
                                                                    ...
                                                                    @foreach ($tax_rates as $tax_rates2)
                                                                        <option value="{{ $tax_rates2->tax_amount.'__'.$tax_rates2->tax_id }}">
                                                                            {{ $tax_rates2->tax_name.' ('.$tax_rates2->tax_amount.' %)' }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                {{-- <input type="text" name="" class="form-control form-control-sm notax">
                                                        ...
                                                        <td class="w-12">
                                                            <div class="form-group form-group-sm">
                                                                <select name="tax[]" class="form-control form-control-sm notax addtax return_sell_tax">
                                                                    ...
                                                                    @foreach ($tax_rates as $tax_rates3)
                                                                        <option value="{{ $tax_rates3->tax_amount.'__'.$tax_rates3->tax_id }}">
                                                                            {{ $tax_rates3->tax_name.' ('.$tax_rates3->tax_amount.' %)' }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                {{-- <input type="text" name="" class="form-control form-control-sm notax">
    ...
    <div class="modal fade add__modal" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('saveproExpense') }}" method="POST" enctype="multipart/form-data"> 
...
@push('script')
    ...
    <script>
        ...
        //******************************  For Supplier Information Start *********************************//
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.catch_product', function () {
                ...
                $.ajax({
                    ...
                    url:"{{route('catch.supp_productRate')}}",
                ...
                $.ajax({
                    ...
                    url:"{{route('catch.supp_productAccount')}}",
