@php 
    ...
    // $last_inv = DB::table('invoices')->orderBy('invoice_id', 'DESC')->first();
...
@section('content')
    ...
    <style>
        ...
        .btn-save2 {
            background: linear-gradient(#7700e6, #5b03b3);
            background-color: rgba(0, 0, 0, 0);
            border: 1px solid #4500a5 !important;
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">                        
                        ...
                        <form action="{{route('store.invoice')}}" method="POST" class="new_invoice_form" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body card-dashboard">
                                <div class="row">
                                    <div class="col-12">
                                        <button class="btn btn-preview mt-1 mb-1" type="button"><i class="fa fa-search" style="color:#00FF00;"></i> Print/Preview</button>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cust_id" class="select2 form-control customer_change" required>
                                                ...
                                                <option value="add_new_cust">Add New Customer</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoice_date" class="form-control form-control-sm datepicker current_date" value="{{date('Y-m-d')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 pull-left">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="due_date" id="" class="form-control form-control-sm datepicker ren_due change_data" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 pull-left">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value='{{$inv->inv_name}}{{sprintf("%'.05d", $last_number)}}' id="invoice_code" class="form-control form-control-sm invoice_number" autocomplete="off" readonly>
                                            <input type="hidden" name="invoice_code" value="{{$last_number}}">
                                            {{-- <span class="emsg hidden text-danger">Please Try another number</span> --}}
                                        </div>
                                    </div>

                                    <div class="res_customer col-md-12 p-0"></div>
                                    
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="reference">Reference</label>
                                            <input type="text" name="reference" id="reference" class="form-control form-control-sm" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="inv_description" id="description" class="form-control form-control-sm" value=""></textarea>
                                        </div>
                                    </div>

                                    @foreach ($cus_fields as $cf)

                                        <div class="form-group col-md-3 extra_input_{{$cf->lvl_id}}">
                                            <label for="" class="label_current_name">{{$cf->field_name}}</label>
                                            <input type="hidden" class="label_current_name" name="new_label_name[]" value="{{$cf->field_name}}">
                                    ...
                                    <div class="no_padding col-md-6" style="margin-bottom: 0.25em;">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 text-right">
                                                 <label class="mt-9 vat">Tax</label>
                                            </div>
                                            ...
                                            <div class="col-md-10 text-right pull-left">
                                                <label class="mt-9"><b>Total ( R )</b></label>
                                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea cols="4" name="invoice_note" placeholder="Add Note" class="form-control"></textarea>
                                </div>                              
                            </div>
                            ...
                            <div class="col-12 p-0 text-center card-footer">
                                ...
                                <div class="row">
                                    <div class="col-md-3 ">  
                                        ...
                                        <button class="btn btn-save2 pull-left mt-1 ml-1 " value="1" name="save_option" type="submit"> Save as Draft</button>
                                        
                                        <!-- <select name="save_option" id="" class="save_type form-control col-md-1">
                                            <option value="0" class="">&#8595;</option>
                                            <option value="1">Save and continue editing</option>
                                    ...
                                    <div class="col-md-3 ">  
                                        ...
                                        <button class="btn btn-save pull-left mt-1 ml-1 " value="2" name="save_option" type="submit"> Submit for Approval</button>
    ...
    {{-- add new sales rep modal --}}
    <div class="modal fade add__sales_rep_modal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('saveSalesRep') }}" method="POST"> 
                    @csrf
        ...
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body bg">
                    ...
                    <a class="add_label success" val='{{$count_cus_fields}}'><i class="ft-plus"></i> Add new field</a>
                    <div class="col-md-12">
                        <br>
                    </div>
                    ...
                    @foreach ($cus_fields as $cf)
                        ...
                        <div class="form-row" val="{{$cf->lvl_id}}">
        
                            <label for="label_name">Label name :</label>
                            <input type="text" class="form-control form-control-sm change_label col-md-11" name="change_label" placeholder="Label Name" value="{{$cf->field_name}}">
...
<script type="text/javascript" src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
    ...
    <script>
        ...
        //******************************  For Client Information Start *********************************//
        $(document).ready( function () {
            $('.add__sales_rep_modal').on('submit', 'form', function(e){
                e.preventDefault();
                $.ajax({
                    ...
                    success: function(resp){
                        if(resp.success){
                            $('.add__sales_rep_modal').modal('hide');
                            Swal.fire({
                                text: resp.msg,
                                type: 'success'
                            }).then(()=>{
                                $('select[name=sales_rep]').append(`<option selected value="${resp.details.id}">${resp.details.firstname} ${resp.details.lastname}</option>`);
                            });
                        }
                    }
                });
            });
            $(document).on('change', 'select[name=sales_rep]', function(){
                if(this.value == 'add_new_sales_rep'){
                    $('.add__sales_rep_modal').modal();
                }
            });
            
            $(document).on('click', '.btn-preview', function() {
                
                var formInvoice = $('.new_invoice_form');
  
                $('.throw_inv_content').html("<h1 class='text-primary text-center'><i class='fa fa-spinner fa-spin fa-2x'></i></h1>");
                if ($('.customer_change').val()) {
                    $.ajax({
        ...
        $(document).ready(function () {
            ...
            var content_data_1 = $('.content_data_1').html();
            ...
            $(document).on('change', '.catch_product', function () {
                ...
                prorateid = $(this).parent().parent().next().next().next().find('.return_sell_rate');
                proaccid = $(this).parent().parent().parent().next().find('.return_sell_acc')
                protax = $(this).parent().parent().parent().next().find('.return_sell_tax'); 
                protaxamount = $(this).parent().parent().parent().find('.return_sell_taxAmount'); 
                amnt =  $(this).parent().parent().parent().find('.amount');

                // var qty = 1;
                qty = $(this).parent().parent().next().next().find('.return_qty').val(1);
        ...
        // Add item, add account, add tax javascript   
        ...
        //******************************  For Settings Start *********************************//
            $(document).ready(function () {
                ...
                var count_cus_fields = {{$count_cus_fields}};
                ...
                $(document).on('keyup', '.change_label', function() {
                    ...
                    $('.extra_input_'+lvl_val).find('.label_current_name').html(label_name);
                    $('.extra_input_'+lvl_val).find('.label_current_name').val(label_name);

                    
                    $.ajax({
    
                        url:"{{route('extraMorefieldname')}}",
