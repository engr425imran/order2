                                        ...
                                        <div class="col-md-12">
                                            <div class="row skin skin-flat">
                                                <div class="col-md-6 col-sm-12">
                                                    <fieldset>
                                                        <input type="checkbox" id="input-1" name="attach_invoice">
                                                        <label for="input-1">Attach invoice to the email</label>
                                                    </fieldset>
                                                    <fieldset>
                                                        <input type="checkbox" id="input-2" name="embed_invoice">
                                                        <label for="input-2">Embed invoice within email</label>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
