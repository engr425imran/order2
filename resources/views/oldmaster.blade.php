...
<head>
    ...
    {{--============================ ALL Css library Start ============================--}}
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('public/new/css/bootstrap.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('public/new/css/bootstrap-extended.css')}}">    
...
<body class="horizontal-menu-2" data-open="click" data-menu="vertical-menu" data-col="2-columns">
    ...
    {{-- *************************** Content Start *************************** --}}
        <div class="app-content content" style="margin-right: 0px;margin-left: 0px;">
        ...
        <footer class="footer footer-static footer-light navbar-border">
            <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
                ...
                <span class="float-md-right d-none d-lg-block">Developed by 
                    <a href="http://fahadamin.com" target="_blank">CubeApps</a>
                </span>
            </p>
        </footer>
    {{-- *************************** Footer End *************************** --}}
